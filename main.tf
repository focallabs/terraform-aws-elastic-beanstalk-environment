...
locals {
  ...
  elb_settings_final = var.tier == "WebServer" ? var.loadbalancer_type == "application" ? merge(concat(local.alb_settings, local.generic_elb_settings), var.alb_settings_override) : concat(local.classic_elb_settings, local.generic_elb_settings) : []
}
